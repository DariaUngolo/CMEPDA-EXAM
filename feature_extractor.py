...
def feature_extractor(folder_path, atlas_file, atlas_txt, metadata_csv, output_csv_prefix, matlab_feature_extractor_path):
    ...
    Returns:
        tuple: A tuple containing:
            ...
            - df_unita (pandas.DataFrame): DataFrame containing the combined mean and standard deviation values.
            - df_media_volume (pandas.DataFrame): DataFrame containing the mean values and volume.
            - df_media_std_volume (pandas.DataFrame): DataFrame containing the mean, standard deviation, and volume values.
            - df_std_volume (pandas.DataFrame): DataFrame containing the standard deviation and volume values.
    """
