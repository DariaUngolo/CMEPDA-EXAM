...
# Start MATLAB engine
    ...
    eng.addpath(".")  # Add the current directory to MATLAB path
...
# Read the metadata CSV file that contains group information (e.g., diagnosis)
    ...
    df_group = pd.read_csv("C:\\Users\\daria\\OneDrive\\Desktop\\ESAME\\AD_CTRL_metadata _AD.csv")
...
if __name__ == "__main__":
    ...
    folder_path = r"C:\Users\daria\OneDrive\Desktop\ESAME\AD_s3\AD_s3"
    ...
    output_csv_prefix = r"C:\Users\daria\OneDrive\Desktop\ESAME\output"
    metadata_csv = r"C:\Users\daria\OneDrive\Desktop\ESAME\AD_CTRL_metadata_AD.csv"
